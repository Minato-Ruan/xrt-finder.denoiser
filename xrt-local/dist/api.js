...
exports.start_listening = void 0;
...
function start_listening(port) {
    ...
    router.post("/new", (0, koa_body_1["default"])(), function (ctx, next) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    index_1.view_window.webContents.send("new_event", result);
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    // })
    // app.listen(port);
    var http_server = http.createServer(app.callback());
    // const https_server = https.createServer(app.callback());
    http_server.listen(port);
    // https_server.listen(port);
    return http_server;
}
exports.start_listening = start_listening;
